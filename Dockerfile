...
# Cache bust v3 — 2026-02-03: bypass Excel magic-byte validation at caller level
RUN echo "CACHE_BUST=v3-excel-bypass BUILD_DATE=${BUILD_DATE} VERSION=${BUILD_VERSION}" > /tmp/build-info.txt && \
